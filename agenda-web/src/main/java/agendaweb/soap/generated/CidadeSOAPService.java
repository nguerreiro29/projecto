 ...
 * 
 */
@WebServiceClient(name = "CidadeSOAPService", targetNamespace = "http://websoap.agenda/", wsdlLocation = "http://localhost:8080/agenda-web/soap/ClienteSOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CIDADESOAPSERVICE_QNAME = new QName("http://websoap.agenda/", "CidadeSOAPService");
    ...
    public CidadeSOAP getCidadeSOAPPort() {
        return super.getPort(new QName("http://websoap.agenda/", "CidadeSOAPPort"), CidadeSOAP.class);
    }
    ...
    public CidadeSOAP getCidadeSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://websoap.agenda/", "CidadeSOAPPort"), CidadeSOAP.class, features);
    }
